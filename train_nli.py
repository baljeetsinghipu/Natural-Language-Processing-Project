...
## Google paths
#parser.add_argument("--nlipath", type=str, default='/content/drive/My Drive/Project/dataset/stsa/', help="stsa data path ")
#parser.add_argument("--outputdir", type=str, default='/content/drive/My Drive/Project/savedir/', help="Output directory")
#parser.add_argument("--outputmodelname", type=str, default='/content/drive/My Drive/Project/model.pickle')
#parser.add_argument("--word_emb_path", type=str, default="/content/drive/My Drive/Project/dataset/GloVe/glove.840B.300d.txt",help="word embedding file path")
...
parser.add_argument("--n_lstm_layers", type=int, default='1', help="number of LSTM Model layer")
